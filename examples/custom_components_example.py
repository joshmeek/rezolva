...
# Training data
training_entities = [
    Entity("1", {"title": "iPhone 12", "description": "Latest Apple smartphone", "brand": "Apple", "category": "Phones"}),
    Entity("2", {"title": "MacBook Pro", "description": "Powerful Apple laptop", "brand": "Apple", "category": "Laptops"}),
    Entity("3", {"title": "Galaxy S21", "description": "Samsung's flagship phone", "brand": "Samsung", "category": "Phones"}),
    Entity("4", {"title": "Galaxy Book", "description": "Samsung's lightweight laptop", "brand": "Samsung", "category": "Laptops"}),
]
...
new_entities = [
    Entity("5", {"title": "iPhone 12 Pro", "description": "Premium Apple smartphone", "brand": "Apple", "category": "Phones"}),
    Entity("6", {"title": "Galaxy Book Pro", "description": "Samsung's premium laptop", "brand": "Samsung", "category": "Laptops"}),
]
