...
training_entities = [
    ...
    Entity("6", {"title": "Galaxy Note 20", "description": "Samsung's productivity powerhouse with S Pen", "brand": "Samsung"}),
    Entity("7", {"title": "Pixel 4a", "description": "Google's budget-friendly smartphone with great camera", "brand": "Google"}),
    Entity("8", {"title": "iPhone 11", "description": "Previous generation Apple smartphone with dual camera", "brand": "Apple"}),
    Entity("9", {"title": "Galaxy A52", "description": "Samsung's mid-range phone with 5G capabilities", "brand": "Samsung"}),
    Entity("10", {"title": "Pixel 4 XL", "description": "Google's previous flagship with advanced camera features", "brand": "Google"}),
]
...
new_entities = [
    Entity("11", {"title": "iPhone 12 Pro Max", "description": "Apple's largest premium smartphone with A14 chip", "brand": "Apple"}),
    Entity("12", {"title": "Galaxy S21 Ultra", "description": "Samsung's premium flagship with Exynos 2100 and S Pen support", "brand": "Samsung"}),
    Entity("13", {"title": "Pixel 5a", "description": "Google's latest mid-range smartphone with 5G", "brand": "Google"}),
]
