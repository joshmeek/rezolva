...
def custom_brand_normalizer(value):
    brand_mapping = {"apple": "Apple Inc.", "samsung": "Samsung Electronics", "google": "Google LLC"}
...
matcher = CosineSimilarityMatcher(
    threshold=0.6, attribute_weights={"title": 2.0, "description": 1.5, "brand": 1.0, "contact": 0.5}
)
...
training_entities = [
    Entity(
        "1",
        {"title": "iPhone 12", "description": "Latest Apple smartphone", "brand": "Apple", "contact": "1-800-275-2273"},
    ),
    Entity(
        "2",
        {
...
new_entities = [
    Entity(
        "4",
        {
            ...
            "description": "Apple's largest premium smartphone",
            "brand": "apple",
            "contact": "18002752273",
        },
    ),
    Entity(
        "5",
        {
            ...
            "description": "Samsung's premium flagship phone",
            "brand": "SAMSUNG",
            "contact": "1 (800) 726-7864",
        },
    ),
